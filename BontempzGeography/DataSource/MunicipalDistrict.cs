...
namespace BontempzGeography.DataSource
{
    public class MunicipalDistrict
    {
        ...
        private static List<MunicipalDistrict> municipalDistrictList = new List<MunicipalDistrict>()
        {
            ...
            new MunicipalDistrict("e5407fb4-6027-4b5d-aa78-d89316fd2721", "9c967a90-32e8-474a-b20b-cf1c5b4fadbf", "AU", "Brunswick Street", "Melbourne", "VIC", "144.9758005 -37.7930328, 144.9731398 -37.8081226, 144.9913359 -37.8099874, 144.9939537 -37.7950676, 144.9939537 -37.7950676, 144.9758005 -37.7930328"),
